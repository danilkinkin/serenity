...
export function Model(props) {
  ...
  useFrame((state) => {
    ...
    shipGroupRef.current.position.y = 0.05 * Math.sin(state.clock.elapsedTime)
  })
  ...
  return (
    <group {...props} dispose={null}>
      <mesh 
        ...
        rotation={[-Math.PI, 1.15, -Math.PI]} scale={-10.89} 
      />
      ...
      <mesh geometry={nodes.leaf_2_1.geometry} material={materials['Group 2']} position={[0.61, 3.43, 4.72]} rotation={[1.57, 0.02, -1.79]} scale={6.97} />
      <mesh geometry={nodes.leaf_3_1.geometry} material={materials['Group 3']} position={[0.79, 3.85, 4.32]} rotation={[1.59, -0.03, -1.88]} scale={6.89} />
      <mesh geometry={nodes.leaf_1_1.geometry} material={materials['Group 11']} position={[-0.73, 3.7, 3.05]} rotation={[1.64, 0.16, -1.9]} scale={6.26} />
